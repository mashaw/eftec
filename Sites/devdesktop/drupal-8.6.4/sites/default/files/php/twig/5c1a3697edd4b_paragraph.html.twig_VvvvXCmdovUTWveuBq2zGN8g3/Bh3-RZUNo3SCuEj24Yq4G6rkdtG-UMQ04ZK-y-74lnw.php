...
(isset($context["view_mode"]) ? $context["view_mode"] : null)) ? (("paragraph--view-mode--" . \Drupal\Component\Utility\Html::getClass((isset($context["view_mode"]) ? $context["view_mode"] : null)))) : ("")), 3 => (( !$this->getAttribute(        // line 46
(isset($context["paragraph"]) ? $context["paragraph"] : null), "isPublished", array(), "method")) ? ("paragraph--unpublished") : ("")));
        // line 49
...
";
    ...
    {
        return new Twig_Source("", "modules/paragraphs/templates/paragraph.html.twig", "/Users/mikeshaw/Sites/devdesktop/drupal-8.6.4/modules/paragraphs/templates/paragraph.html.twig");
    }
}
